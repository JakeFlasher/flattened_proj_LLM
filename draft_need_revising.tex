...
% ### paper edit starts
% The following sentence does not contain any useful information, please revise it.
...
% ### paper edit starts
% the following caption is useless and does not contain useful information, please revise it
...
% ### paper edit starts
% Please provide a rewritten of the conclusion, the current one is not informative enough for top-tier conferences like ISCA, HPCA and MICRO 
